...
- category: setup
- url: https://tetrisopener.wicurio.com/index.php?QT%E7%A0%B2
...
## Mini-Triple(MT)
- search-terms: mt minitriple ミニ トリプル ts
- category: setup
- url: https://knewjade.github.io/fumen-for-mobile/#?d=v115@tgB8IeA8DeD8AeH8BeH8BeG8CeE8JeAgWJAteEfEXU?b9ARAAAAvhG1bfdmfdrf1vBAAAdrBAAAtgB8IeA8DeD8AeG?8CeG8BeAAAeF8AeB8AeD8JeAAPJAteEfEXUb9ASAAAAvhF1?bfdmf1qfNqBAAAdrB
...
## Trinity(トリニティ)
- search-terms: trinity トリニティ tsd
- category: setup
...
## TKI
- search-terms: tki-3 tki3 tsd c td
- category: setup
...
- search-terms: albatross アルバトロス アルバ sp
- category: setup
...
- search-terms: 7piecepuzzle パフェ 積み
- category: setup
...
- search-terms: liuqiaoban gracesystem 1stpc グレース パフェ
- category: setup
...
- search-terms: gamushiro ガムシロ td
- category: setup
...
## TD
- search-terms: cspin tki td
- category: pattern
- url: https://harddrop.com/wiki?search=Triple Double_Attack_Setups
...
## Fractal(ダブルダガー)
- search-terms: shuangrenjian fractal spider ダブル 2 ダガー フラクタル ダブダ
- category: pattern
...
## Hamburger(ハンバーガー)
- search-terms: hamburger ハンバーグ ハンバーガー
- category: pattern
...
- search-terms: imperialcross インペリ
- category: pattern
...
## Kaidan(階段ドネイト)
- search-terms: jieti kaidan stairs 階段
- category: pattern
...
- search-terms: shachikutrain shechu 社畜 トレイン
- category: pattern
...
## Cut Copy
- search-terms: qianniao cutcopy 千鳥 カット
- category: pattern
...
- search-terms: kingcrimson キンクリ キング jojo ジョジョ
- category: pattern
...
## Reset setting
- search-terms: reset setting リセット 設定
- category: command
...
## Reset statistics
- search-terms: reset statistic data リセット 統計 データ
- category: command
...
## Reset unlock
- search-terms: reset unlock リセット 未開封
- category: command
...
## Reset records
- search-terms: reset record リセット レコード 記録
- category: command
...
## Reset key
- search-terms: reset virtualkey リセット キー 仮想
- category: command
...
## Delete replays
- search-terms: delete recording 削除 消去 リセット デリート リプレイ
- category: command
...
## Delete cache
- search-terms: delete cache 消去 削除 リセット デリート キャッシュ
- category: command
...
## BGM
- search-terms: backgroundmusic 音楽
- category: english
...
## Timing
- search-terms: timing shiji fanji タイミング
- category: term
